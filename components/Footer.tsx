  ...
  return (
    <footer className="flex w-full justify-center items-center flex-col gap-10 py-10">
      <Link
        aria-label="My Logo"
        href={"/"}
        className="font-bold text-2xl sm:text-4xl text-white leading-8 flex items-center justify-center w-fit gap-1 sm:p-2"
      >
        <Image
          src="/MYLOGO.svg"
          width={150}
          height={150}
          alt="Logo"
          className="mx-auto object-contain max-w-40"
        />
      </Link>
      <div>
      ...
      <div className="flex flex-wrap gap-6 justify-center items-center px-6 py-2 rounded-full sp">
        <Link
          ...
          className="flex items-center font-medium text-lg rounded-full "
        >
          <svg
