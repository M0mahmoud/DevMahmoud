...
import aiTravel from "@/assets/ai-travel.png";
...
export const PROJECTS = [
  ...
  },
  {
    ...
    desc: "Build a dynamic travel dashboard with React, React Router v7, Syncfusion, Appwrite, and Gemini AI! Master authentication, create interactive charts, and integrate Gemini AI for outstanding features.",
    codeLink: "https://github.com/M0mahmoud/ai-travel-dashbboard-05",
    demo: "https://ai-travel-dashboard-05.vercel.app/",
    image: aiTravel,
  },
];
const Pojects = () => {
    ...
    <section id="projects" className="py-10">
      <div className="flex items-center justify-center flex-col gap-3 mb-8">
        ...
        <p className="max-w-lg font-medium  text-gray-400">
          Each showcases my skills in creating user-friendly and visually
          appealing web applications. Dive in to see how I bring ideas to life
          with cutting-edge technologies and innovative designs.
        </p>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 py-5">
        {PROJECTS.map((project) => (
          <div
            className="project rounded-lg bg-dark-2 w-full pb-3"
            key={project.id}
          >
            <Image
              alt={project.title}
              ...
              height={400}
              loading="lazy"
              className="w-full object-cover max-h-52 min-h-52 rounded-t-lg mb-6"
            />
                ...
                {project.demo && (
                  <Link aria-label="Demo Link" href={project.demo}>
                    <svg
                      ...
                      viewBox="0 0 640 512"
                      className="inline-flex w-6 h-6 fill-white"
                    >
